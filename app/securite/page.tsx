  ...
  return (
    <StaticPage
      ...
      sections={[
        ...
        { h: "✅ Vérifiez le vendeur", p: "Regardez le profil, le badge « Vérifié » / « PRO » quand il existe, et privilégiez toujours un échange clair avant la rencontre. En cas de doute, signalez l'annonce." },
