...
export default function SecuritePage() {
  return (
    <StaticPage
      ...
      sections={[
        { h: "🛡️ Ne payez jamais à l'avance", p: "Méfiez-vous de tout vendeur qui exige un acompte avant la rencontre. Annonce.ID ne demandera jamais de paiement pour un produit — uniquement pour booster vos annonces." },
