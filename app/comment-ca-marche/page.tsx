...
export const metadata: Metadata = {
  title: "Comment ça marche | Wanteermako",
  description: "Découvrez comment vendre et acheter facilement sur Wanteermako en 3 étapes simples.",
};
    ...
    <div className="mx-auto max-w-[1000px] px-4 py-12 md:py-20">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-[1.1rem] text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Que vous souhaitiez faire de la place chez vous ou développer votre commerce, vendre sur Wanteermako est un jeu d'enfant.
        </p>
      </div>
