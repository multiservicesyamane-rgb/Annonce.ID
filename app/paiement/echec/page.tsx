...
export default function PaiementEchec() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50 via-gray-50 to-white py-10 transition-colors dark:from-[#2a0808] dark:via-black dark:to-black sm:py-16">
      <div className="mx-auto max-w-[540px] px-3 sm:px-4">
        <div className="overflow-hidden rounded-[24px] border border-gray-100 bg-white shadow-[0_20px_60px_-20px_rgba(239,68,68,0.35)] dark:border-white/10 dark:bg-[#111722]/90 dark:backdrop-blur-xl animate-fadeUp">
          {/* En-tête */}
          <div className="relative bg-gradient-to-br from-red-400 via-rose-500 to-red-500 px-5 py-9 text-center text-white sm:px-8 sm:py-11">
            <div
            ...
            <div className="relative">
              ...
              <h1 className="font-display text-[1.5rem] font-extrabold sm:text-[1.8rem]">Le paiement a échoué</h1>
          ...
          <div className="p-5 sm:p-7">
            <p className="text-center text-[.9rem] leading-relaxed text-gray-500 dark:text-gray-400">
              La transaction n'a pas pu aboutir (solde insuffisant, interruption réseau ou refus de
              l'opérateur). <b className="text-gray-700 dark:text-gray-200">Rien ne vous a été facturé.</b>
            </p>

            <div className="mt-4 rounded-2xl border border-gray-100 bg-gray-50/80 p-4 text-[.8rem] text-gray-500 dark:border-white/5 dark:bg-white/5 dark:text-gray-400">
              💡 <b className="text-gray-700 dark:text-gray-200">Conseils :</b> vérifiez votre solde
              Wave / Orange Money, restez sur la page jusqu'à la confirmation, puis réessayez.
            </div>
